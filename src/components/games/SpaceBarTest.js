        ...
        <div className={styles['spacebar-test']}>
            ...
            <div className={styles['timer-options']}>
                {[1, 3, 5, 10, 15, 30, 60, 100].map(time => (
                    <button key={time} className={styles['timer-button']}>
                        {time}
                    </button>
                ))}
            ...
            <p className={styles.description}>
                스페이스바 타자속도 테스트는 스페이스바 속도 테스트 등으로도 불리며, 이를 통해 당신의 손가락 속도를 측정할 수 있습니다. 테스트 규칙은 단 하나, 스페이스바를 미친듯이 내려치는 것입니다! (키보드는 생각보다 단단하니 부서질 걱정은 안 하셔도 됩니다). 위 숫자에서 선택한 시간 {15}초만큼 스페이스바를 계속 쳐주세요.
                <br />
                친구들과 겨뤄보는 것도 잊지 마세요!
                <br />
